...
#
# Data preprocessing for the FC_mordred model
################################################################################
...
class Dataset_PDB(Dataset):
    ...
    def __getitem__(self,ind):
        ...
        with h5py.File(fpath, "r", driver=self.h5_driver) as h5:
            ...
            if h5_coord in h5_data and h5_feat in h5_data and h5_efeat in h5_data and h5_mordred in h5_data:
                coord = h5_data[h5_coord][:]
                feat = h5_data[h5_feat][:]
                efeat = h5_data[h5_efeat][:]
                mordred = h5_data[h5_mordred][:]
            ...
            mordred_fixed = np.nan_to_num(mordred, nan=0.0)
            mordred_tensor = torch.from_numpy(mordred_fixed)
